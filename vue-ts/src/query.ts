...
): UseQueryOptions<Awaited<ReturnType<typeof getAxiosAxios>>, TError, TData>  => {
const {query: queryOptions} = options ?? {};

  const queryKey =  getGetAxiosAxiosQueryKey();
...
): UseQueryOptions<Awaited<ReturnType<typeof getTanStackQuery>>, TError, TData>  => {
const {query: queryOptions} = options ?? {};

  const queryKey =  getGetTanStackQueryQueryKey();
