...
export const getGetAxiosAxiosQueryOptions = <TData = Awaited<ReturnType<typeof getAxiosAxios>>, TError = ErrorType<unknown>>(options?: { query?: CreateQueryOptions<Awaited<ReturnType<typeof getAxiosAxios>>, TError, TData>, }
): CreateQueryOptions<Awaited<ReturnType<typeof getAxiosAxios>>, TError, TData> & { queryKey: QueryKey } => {
 ...
 * @summary Get information about the "axios/axios" repository
 */
export const createGetAxiosAxios = <TData = Awaited<ReturnType<typeof getAxiosAxios>>, TError = ErrorType<unknown>>(
  options?: { query?: CreateQueryOptions<Awaited<ReturnType<typeof getAxiosAxios>>, TError, TData>, }
...
export const getGetTanStackQueryQueryOptions = <TData = Awaited<ReturnType<typeof getTanStackQuery>>, TError = ErrorType<unknown>>(options?: { query?: CreateQueryOptions<Awaited<ReturnType<typeof getTanStackQuery>>, TError, TData>, }
): CreateQueryOptions<Awaited<ReturnType<typeof getTanStackQuery>>, TError, TData> & { queryKey: QueryKey } => {
  const { query: queryOptions } = options ?? {};
 ...
 * @summary Get information about the "TanStack/query" repository
 */
export const createGetTanStackQuery = <TData = Awaited<ReturnType<typeof getTanStackQuery>>, TError = ErrorType<unknown>>(
  options?: { query?: CreateQueryOptions<Awaited<ReturnType<typeof getTanStackQuery>>, TError, TData>, }
